...
(define tests
  (test-suite
   ...
   (check-equal? (stream-for-n-steps ones 0) null "stream-for-n-steps-edge-case-test")

   (check-equal? (stream-for-n-steps nats 5) (list 1 2 3 4 5) "stream-for-n-steps-new-stream")
